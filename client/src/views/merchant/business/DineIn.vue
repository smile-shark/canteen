<template>
  <div class="dine-in-management">
    ...
    >
      ...
      <el-table-column prop="isDineIn" label="堂食状态" align="center">
        <template #default="scope">
          <el-tag :type="scope.row.isDineIn == 0 ? 'success' : 'danger'">
            {{ scope.row.isDineIn == 0 ? '开启' : '关闭' }}
          </el-tag>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" align="center" width="200">
        <template #default="scope">
          <el-radio-group v-model="scope.row.isDineIn" @input="handleIsDineInChange(scope.row)">
...
export default {
  ...
  methods: {
    ...
    handleSearch(page) {
      ...
      api.shop.pageListDineIn(this.pagination.pageNum,this.pagination.pageSize,this.searchForm.storeId,this.searchForm.status).then(res=>{
